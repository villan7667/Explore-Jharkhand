...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const placesDropdownTrigger = document.getElementById(
    "places-dropdown-trigger"
  );
  const placesDropdownContent = document.getElementById(
  ...
  function setActiveNavLink() {
    ...
    document
      .querySelectorAll(".nav-list a, .mobile-nav-link, .dropdown a")
      .forEach((link) => {
    ...
    if (currentPage) {
      ...
      if (currentPage === "places") {
        const dropdownLinks = document.querySelectorAll(
          ".dropdown a, .mobile-dropdown-content a"
        );
  ...
  function updateUserDisplay(username) {
    ...
    const displayName =
      username === "Guest" ? "Guest" : `Logged in as ${username}`;
